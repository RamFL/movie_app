...
import 'package:movie_app/models/tv_models/airing_today_tv_model.dart';
...
class AiringTodayTVShows extends StatefulWidget {
  ...
  @override
  State<AiringTodayTVShows> createState() => _AiringTodayTVShowsState();
}
...
class _AiringTodayTVShowsState extends State<AiringTodayTVShows> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: 250,
      child: FutureBuilder(
        future: apiService.getAiringTodayTV(),
